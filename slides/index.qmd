...
- Calcul des poids optimaux et de la qualité d'un arbre, à structure d'arbre donnée;
- Définition d'une méthode et de critère permettant de choisir la structure d'un arbre.
...
- On peut utiliser cette dernière formule pour évaluer le gain (réduction de la fonction-objectif) induit par un _split_ marginal:
...
- Cette formule est essentielle: elle permet de comparer les _splits_ possibles lorsqu'on construit l'arbre.
